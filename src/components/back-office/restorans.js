                ...
                return (
                    <RVD
                        layout={{
                            ...
                            column: [{html: (<RestoranCard type={type} restoran={restoran}/>)}]
                        }}
                    />
                )
            }
...
class RestoranCard extends Component {
    ...
    foods_layout() {
        ...
        return (
            <RVD
                layout={{
                    onClick: () => this.openFoods(),style: { border: '1px dashed #333', height: 72 },
                    column: [
                        { flex: 1 },
    ...
    map_layout() {
        ...
        return (
            <RVD
                layout={{
                    onClick: () => this.openMap(),style: { border: '1px dashed',fontSize:12, height: 72,...style },
                    column: [
                        { flex: 1 },
    ...
    remove_layout() {
        ...
        return (
            <RVD
                layout={{
                    onClick: () => remove_restoran(model.id),
    ...
    image_layout() {
        ...
        return (
            <AIOInput
                ...
                style={{width: 200,height: 72,border: '1px dashed #333'}}
            />
    ...
    logo_layout() {
        ...
        return (
            <AIOInput
                ...
                style={{width: 72,height: 72,border: '1px dashed #333'}}
            />
            ...
            <RVD
                layout={{
                    ...
                    row: [
                        ...
                        {show: type === 'edit' && isModelChanged,html: (<button className='bo-edit-button' onClick={() => edit_restoran(model)}>ویرایش</button>)},
        ...
        return (
            <ProductManager
                ...
                extraOptions={[
                    ...
                    {type:'text',field:'model.menuCategory',label:'دسته منو'},
